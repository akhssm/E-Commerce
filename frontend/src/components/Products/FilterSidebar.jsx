        ...
        {categories.map((category) => (
          <div key={category} className="flex items-center mb-1">
            <input 
              ...
              className="mr-2 h-4 w-4 text-blu-500 focus:ring-blue-400 border-gray-300" 
            />
        ...
        <div className="flex flex-wrap gap-2">
          {colors.map((color) => (
            <button
              ...
              className={`w-8 h-8 rounded-full border border-gray-300 dursor-pointer transition
              hover:scale-105 ${
